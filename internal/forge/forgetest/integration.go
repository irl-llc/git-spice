...
const (
	// CredentialSourceEnv indicates credentials
...
// Credential retrieves authentication credentials
// for the given forge URL.
// This is useful for forges like Bitbucket
...
// the appropriate auth type
// (e.g., Basic for app passwords, Bearer for OAuth).
func Credential(
	t *testing.T,
