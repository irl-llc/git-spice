...
func (r *Repository) fetchAndYieldComments(
	...
	for path != "" {
		...
		if !r.yieldFilteredComments(comments, opts, yield) {
			return
		}
		path = nextPath
	}
...
func (r *Repository) yieldFilteredComments(
	comments []apiComment,
	opts *forge.ListChangeCommentsOptions,
	yield func(*forge.ListChangeCommentItem, error) bool,
) bool {
...
func convertComment(c *apiComment) *forge.ListChangeCommentItem {
